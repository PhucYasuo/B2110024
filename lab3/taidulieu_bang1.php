...
$sql = "SELECT * FROM student s, major m WHERE s.major_ID = m.ID";
...
//load du lieu moi len dua vao bien result
    ...
    <table border=1><tr><th>ID</th><th>Ho ten</th><th>Email</th><th>Ngay sinh</th><th>Ma nganh</th><th>Ten nganh</th><th colspan="2">Hanh dong</></tr>
    <?php
